...
var namesInIrish = [
	...
	//heros of the Gael 
		...
		let map = [[`59`,`3`,`52`,`49`,`28`,`7`,`23`,`47`,`22`,`.`,`36`,`.`,`37`,`.`,`16`,`19`,`.`,`56`,`55`,`.`,`53`,`6`,`27`,`.`,`.`,`33`,`10`,],
	...
	// } 
			...
			for (var row = 0; row < ROWS; row++) {
				for (var column = 0; column < COLUMNS; column++) {
					...
					//Create a img tag called easca-cell
					var eascaCell = document.createElement("img");
	idCounter ++;
					//Set it's CSS class to "eascaCell"
					eascaCell.setAttribute("class", "eascaCell");
					eascaCell.setAttribute("id", idCounter);
	
					//Add the img tag to the <div id="eascaStage"> tag
					eascaStage.appendChild(eascaCell);
	
					//Find the correct image for this map eascaCell
					switch (map[row][column]) {
						case grass: eascaCell.src = empty;
							break;
						case a1: eascaCell.src = aa1
							break;
						case a2: eascaCell.src = aa2 
							break;
				case a3: eascaCell.src = aa3
							break;
				case a4: eascaCell.src = aa4
							break;
				case a5: eascaCell.src = aa5
							break;
				case a6: eascaCell.src = aa6
							break;
				case a7: eascaCell.src = aa7
							break;
				case a8: eascaCell.src = aa8
							break;
				case a9: eascaCell.src = aa9;
							break;
				case a10: eascaCell.src = aa10;
							break;
				case a11: eascaCell.src = aa11;
							break;
				case a12: eascaCell.src = aa12
							break;
				case a13: eascaCell.src = aa13
							break;
				case a14: eascaCell.src = aa14
							break;
				case a15: eascaCell.src = aa15;
							break;
				case a16: eascaCell.src = aa16;
							break;
						case a17: eascaCell.src = aa17;
							break;
				case a18: eascaCell.src = aa18;
							break;
				case a19: eascaCell.src = aa19;
							break;
				case a20: eascaCell.src = aa20;
							break;
				case a21: eascaCell.src = aa21;
							break;
				case a22: eascaCell.src = aa22;
							break;
				case a23: eascaCell.src = aa23;
							break;
				case a24: eascaCell.src =aa24;
							break;
				case a25: eascaCell.src = aa25;
							break;
				case a26: eascaCell.src = aa26;
							break;
				case a27: eascaCell.src = aa27;
							break;
				case a28: eascaCell.src = aa28;
							break;
				case a29: eascaCell.src = aa29;
							break;
				case a30: eascaCell.src = aa30;
							break;
				case a31: eascaCell.src = aa31;
							break;
				case a32: eascaCell.src = aa32;
							break;
				case a33: eascaCell.src = aa33;
							break;
				case a34: eascaCell.src = aa34;
							break;
				case a35: eascaCell.src = aa35;
							break;
				case a36: eascaCell.src = aa36;
							break;
				case a37: eascaCell.src = aa37;
							break;
				case a38: eascaCell.src = aa38;
							break;
				case a39: eascaCell.src = aa39;
							break;
				case a40: eascaCell.src = aa40;
							break;
				case a41: eascaCell.src = aa41;
							break;
				case a42: eascaCell.src =aa42
							break;
				case a43: eascaCell.src = aa43;
	
							break;
				case a44: eascaCell.src = aa44;
	
							break;
				case a45: eascaCell.src = aa45;
							break;
				case a46: eascaCell.src = aa46;
							break;
				case a47: eascaCell.src = aa47;
							break;
				case a48: eascaCell.src = aa48;
							break;
				case a49: eascaCell.src = aa49;
							break;
				case a50: eascaCell.src =aa50;
							break;
				case a51: eascaCell.src = aa51;
							break;
				case a52: eascaCell.src = aa52;
							break;
				case a53: eascaCell.src =aa53;
							break;
				case a54: eascaCell.src =aa54;
							break;
				case a55: eascaCell.src = aa55;
							break;
				case a56: eascaCell.src =aa56;
							break;
				case a57: eascaCell.src =aa57;
							break;
				...
				case a60: eascaCell.src = aa60;
					...
					eascaCell.style.top = row * SIZE + "px"; eascaCell.style.left = column * SIZE + "px";
	...
	let					currentChamp = charId;
		...
		let				haveWeStartedYet = true;
			...
			// let		champ = champions[charId];
				...
				$('.eascaCell').on('touchend click', function () {
					if(this.src.includes('empty')){
						
					}
					else{
						//set player-icon to this eascaCell's image.
						// beep2.play();
			// 			if(theme.paused){
			// theme.play();
		...
		// }
			...
			$('#fortuna-bg').fadeIn();
				...
				$('#fortuna-lit').fadeOut(1000)
					...
					$('.eascaCell').removeClass('chosen')
					$(this).addClass('chosen')
					// $(this).css("borderRadius","50%");
					setTimeout(function(){
						$('.eascaCell').css("backgroundColor","rgba(00,50,150,0)");
	
						$('.eascaCell').css("border","none");
					},1000)
